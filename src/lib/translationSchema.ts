...
export const SectionSchema = z
  ...
  .refine((value) => Boolean(value.title || value.heading), {
    message: "Either title or heading is required",
    path: ["title"],
  });
...
export const EquipmentSchema = z
  ...
  .refine((value) => Boolean(value.name || value.item), {
    message: "Either name or item is required",
    path: ["name"],
  })
  .refine((value) => Boolean(value.description || value.benefit), {
    message: "Either description or benefit is required",
    path: ["description"],
  });
...
export const CategorySchema = z
  ...
  .refine((value) => Boolean(value.name || value.type), {
    message: "Either name or type is required",
    path: ["name"],
  });
