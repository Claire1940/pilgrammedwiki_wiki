...
export default function Navigation({
  ...
  const [mobileRandomArticles, setMobileRandomArticles] = useState<
    NavPreviewArticle[]
  >([]);
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        ...
        !wikiDropdownRef.current.contains(event.target as Node)
      ) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative hidden sm:block" ref={wikiDropdownRef}>
              ...
              >
                {t("common.moreWikis")}
                <ChevronDown
                  className={`w-3 h-3 ml-1 transition-transform ${wikiMenuOpen ? "rotate-180" : ""}`}
                />
              </Button>
            ...
            <div className="flex flex-col space-y-1">
              ...
              <div className="px-4">
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-4 h-4 transition-transform ${mobileWikiExpanded ? "rotate-180" : ""}`}
                  />
                </button>
                {mobileWikiExpanded && (
